...
export const EXERCISE_CATALOG: Record<string, string[]> = {
  ...
  Calentamiento: [
    "Carrera suave en sitio",
    "Saltos de tijera (jumping jacks)",
    "Rotación de cadera",
    "Círculos de hombros",
    "Marcha con rodillas al pecho",
    "Leg swings frontales",
    "Leg swings laterales",
    "Hip circle",
    ...
    "Apertura de cadera lateral",
    "Plancha dinámica",
  ],
  Estiramientos: [
    "Estiramiento de cuádriceps (de pie)",
    "Estiramiento de isquiotibiales",
    "Estiramiento de pectorales (doorway)",
    "Estiramiento de dorsales",
    "Estiramiento de hombro (cross-body)",
    "Estiramiento de trapecio",
    "Estiramiento de tríceps",
    "Pigeon pose (glúteo/cadera)",
    "Cobra (flexores de cadera)",
    "Cat-cow (columna)",
    "Estiramiento de pantorrillas",
    "Mariposa (aductores)",
    "Psoas lunge",
    "Child's pose",
    "Estiramiento de TFL (banda iliotibial)",
    "Rotación lumbar en suelo",
  ],
};
